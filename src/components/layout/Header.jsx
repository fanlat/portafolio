...
export const Header = () => {
  ...
  return (
    <header className='header z-30 bg-needle-green shadow-lg'>
      <nav className='info mx-auto max-w-7xl flex items-end flex-col sm:flex-row justify-between px-2 sm:px-6 py-5 lg:px-8'>
        <div className='flex items-end justify-between w-full'>
          <div className='relative w-fit'>
            <NavLink to="/" className="flex items-end justify-between">
              ...
              <h1 className='name ml-3 text-needle-text'><strong className='m-0'>Gustavo Pozo</strong><br />Front End</h1>
            </NavLink>
          </div>
        ...
        <div id='navbar-default' className='hidden sm:flex items-end justify-between w-full text-center mt-5 sm:mt-0 sm:w-fit gap-20'>
          <ul className='flex flex-col sm:flex-row  gap-5 text-3xl'>
            <li>
              <NavLink onClick={closeMenu} title='home' to='/' className='text-needle-text transition-colors duration-500 hover:text-summer-green-800'>Inicio</NavLink>
              </li>
            <li>
              <NavLink onClick={closeMenu} title='proyectos' to='/proyectos' className='text-needle-text transition-colors duration-500 hover:text-summer-green-800'>Proyectos</NavLink>
              </li>
            <li>
              <NavLink onClick={closeMenu} title='contacto' to='/contacto' className='text-needle-text transition-colors duration-500 hover:text-summer-green-800'>Contacto</NavLink> 
              </li>
          </ul>
          <div className='flex flex-col sm:flex-row justify-center mt-5 gap-4'> 
            <a href='https://www.linkedin.com/in/gustavo-pozo-n/' title='linkedin' target='_blank' rel='noreferrer' className='text-needle-text mx-auto sm:mx-0 transition-colors duration-500 hover:text-blue-600'>
            ...
            <a href='https://wa.link/2ps0he' title='whatsapp' target='_blank' rel='noreferrer' className='text-needle-text mx-auto sm:mx-0 transition-colors duration-500 hover:text-green-500'>
