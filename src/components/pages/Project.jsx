...
export const Project = () => {
  return (
    <main id="proyect" className='bg-needle-vanilla flex flex-col justify-center pt-24 pb-10 bg-whitepx-5 px-4 sm:px-0'>
         <Helmet>
        ...
        <header className='mb-20'>
            <h2 className='text-needle-text text-4xl sm:text-6xl font-bold uppercase text-center'>Proyectos</h2>
        </header>
